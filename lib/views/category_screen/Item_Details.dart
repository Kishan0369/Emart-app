            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        children: [
                          ...
                          5.heightBox,
                          "In House Brands".text.white.fontFamily(bold).color(darkFontGrey).size(16).make(),
                        ],
                      )),
                      const CircleAvatar(
                  ...
                  10.heightBox,
                  "This is a Items and Description Here.....".text.color(darkFontGrey).make(),
                  ...
                  20.heightBox,
                  productsmaylike.text.fontFamily(bold).size(16).color(darkFontGrey).make(),
